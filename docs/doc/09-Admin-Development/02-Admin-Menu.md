...
2. Hệ thống gọi Action `admin_menu` để cho phép TẤT CẢ các Plugin/Theme/Packages đăng ký Menu ảo vào bộ nhớ.
...
add_action('admin_menu', 'register_my_gift_menu');
...
add_action('admin_menu', 'register_my_gift_menus');
