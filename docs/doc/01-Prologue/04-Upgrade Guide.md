...
- Bước 2: Tiến hành up version cms
- Bước 3: Vào thư mục applications/helpers xóa file Cache.php
- Bước 4: Cập nhật tất cả plugin lên phiên bản mới
- Bước 5: Kích hoạt lại plugin
- Bước 6: Kiểm tra lại footer sau khi up

**Lưu ý khi up từ ver `7.1.x` lên phiên bản mới nhất**

- Bước 1: Tắt plugin sicommerce-cart
- Bước 2: Tiến hành up version cms
