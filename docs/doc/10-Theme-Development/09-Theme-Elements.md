# Hướng Dẫn Tạo Widget Element Cho Hệ Thống Builder
...
| Loại | Vị trí trong [widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json) | Sử dụng |
|---|---|---|
...
| [header](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/ElementBuilder.php#12-16) | Header | Logo, Cart, Search |
| `heading` | Tiêu đề | Các kiểu heading |
| [footer](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/ElementBuilder.php#22-26) | Footer | Footer blocks |
...
### Bước 3: Đăng ký Element trong [widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json)

Mở file [views/theme-store/widget/widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json) và thêm vào mục `elements`:
...
| ⚙️ **Nâng cao** | `advanced` | Spacing, Motion Effects (tự động thêm bởi [Element](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/Element.php#6-159)) |
...
Sử dụng `addGroup()` + [groupFormBox()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/Element.php#37-44) để tạo các nhóm có thể collapse:
...
## 5. CSS Builder — Tùy Chỉnh Giao Diện ([cssSelector](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234))

### 5.1 Tổng quan

Sử dụng [cssSelector()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234) để tạo CSS động dựa trên dữ liệu từ các style builder fields. Method này **tự động xử lý responsive** (desktop/tablet/mobile) và **hover/active states** — không cần khai báo device mapping thủ công.

> [!WARNING]
> **Không sử dụng [cssStyle()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#221-227)** — đây là API cũ, yêu cầu khai báo `options => ['desktop' => 'css', 'tablet' => 'cssTablet', ...]` thủ công. Hãy dùng [cssSelector()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234) cho tất cả element mới.

### 5.2 Cú pháp [cssSelector](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234)
...
> [!NOTE]
> Bạn có thể viết `'style' => 'text'` hoặc `'style' => 'cssText'` — hệ thống tự động thêm prefix [css](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/video/assets/video-widget.css) + `ucfirst` nếu chưa có.

### 5.5 Ví dụ đầy đủ [cssBuilder()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/products-category/style1/product-category-style1.widget.php#137-185)
...
### 5.6 So sánh [cssStyle](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#221-227) (cũ) vs [cssSelector](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234) (mới)

| | [cssStyle](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#221-227) ❌ (cũ) | [cssSelector](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#228-234) ✅ (mới) |
|---|---|---|
...
| **Nhiều properties** | Gọi nhiều lần [cssStyle()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#221-227) | Truyền variadic args |
...
### 6.5 Đăng ký trong [widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json)
...
Element có thể chứa các widget con bên trong bằng [widgetContainer()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/Element.php#45-153):
...
- [ ] **Tạo class** extends [Element](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Element/Element.php#6-159), implement 4 methods bắt buộc:
  - [ ] [icon()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/tabs/tabs.widget.php#14-18) — trả về icon key
  - [ ] [category()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/video/video.widget.php#20-24) — trả về category key
  - [ ] [form()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/tabs/tabs.widget.php#24-153) — khai báo form fields + gọi `parent::form()`
  - [ ] [widget()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/video/video.widget.php#74-86) — render HTML output
- [ ] **Tạo Blade view** trong [views/view.blade.php](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/text-editor/views/view.blade.php)
- [ ] **(Tùy chọn)** Tạo CSS/LESS trong [assets/](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/packages/skilldo/cms/src/Widget/WidgetBase.php#108-122)
- [ ] **(Tùy chọn)** Override [default()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/video/video.widget.php#128-144) cho giá trị mặc định
- [ ] **(Tùy chọn)** Override [cssBuilder()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/products-category/style1/product-category-style1.widget.php#137-185) cho CSS động
- [ ] **Đăng ký** trong [widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json) với key = tên class
- [ ] **Kiểm tra** trong Admin → Builder

> [!WARNING]
> **Key trong [widget.json](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/widget.json)** phải **giống hệt** tên class PHP. Nếu class là `AlertBoxWidgetElement` thì key phải là `"AlertBoxWidgetElement"`, không phải `"alert_box_widget_element"` hay bất kỳ biến thể nào khác.

> [!CAUTION]
> Luôn gọi `parent::form()` ở **cuối** method [form()](file:///e:/GoogleDriverData/projects/source.5.x/sourcev8/views/theme-store/widget/elements/tabs/tabs.widget.php#24-153). Nếu không, các field mặc định trong tab Advanced (spacing, scroll effects) sẽ không hoạt động đúng.